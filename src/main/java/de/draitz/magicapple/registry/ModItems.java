...
public class ModItems {
    ...
    // --- Empowered Berserker Apple ---
    public static final DeferredItem<Item> EMPOWERED_BERSERKER_APPLE =
            MagicApple.ITEMS.registerItem("empowered_berserker_apple",
                    properties -> new EmpoweredMagicAppleItem(properties.food(MAGIC_FOOD).rarity(Rarity.EPIC),
    ...
    // --- Empowered Blaze Apple ---
    public static final DeferredItem<Item> EMPOWERED_BLAZE_APPLE =
            MagicApple.ITEMS.registerItem("empowered_blaze_apple",
                    properties -> new EmpoweredMagicAppleItem(properties.food(MAGIC_FOOD).rarity(Rarity.EPIC),
    ...
    public static final DeferredItem<Item> EMPOWERED_MINING_APPLE =
            MagicApple.ITEMS.registerItem("empowered_mining_apple",
                    properties -> new EmpoweredMagicAppleItem(properties.food(MAGIC_FOOD).rarity(Rarity.EPIC),
                            new MobEffectInstance(MobEffects.HASTE, 3600, 1),
                            new MobEffectInstance(MobEffects.LUCK, 3600, 0),
                            new MobEffectInstance(MobEffects.NIGHT_VISION, 400, 0)
                    ));

    // --- Empowered Nightseer Apple ---
    public static final DeferredItem<Item> EMPOWERED_NIGHTSEER_APPLE =
            MagicApple.ITEMS.registerItem("empowered_nightseer_apple",
                    properties -> new EmpoweredMagicAppleItem(properties.food(MAGIC_FOOD).rarity(Rarity.EPIC),
                            new MobEffectInstance(MobEffects.NIGHT_VISION, 12000, 0),
                            new MobEffectInstance(MobEffects.SPEED, 200, 0)
                    ));

    // --- Empowered Omen Apple ---
    public static final DeferredItem<Item> EMPOWERED_OMEN_APPLE =
            MagicApple.ITEMS.registerItem("empowered_omen_apple",
                    properties -> new EmpoweredMagicAppleItem(properties.food(MAGIC_FOOD).rarity(Rarity.EPIC),
                            new MobEffectInstance(MobEffects.BAD_OMEN, 12000, 0),
                            new MobEffectInstance(MobEffects.STRENGTH, 400, 0)
                    ));

    // --- Empowered Phantom Apple ---
    public static final DeferredItem<Item> EMPOWERED_PHANTOM_APPLE =
            MagicApple.ITEMS.registerItem("empowered_phantom_apple",
                    properties -> new EmpoweredMagicAppleItem(properties.food(MAGIC_FOOD).rarity(Rarity.EPIC),
                            new MobEffectInstance(MobEffects.INVISIBILITY, 3600, 0),
                            new MobEffectInstance(MobEffects.SPEED, 200, 0)
                    ));

    // --- Empowered Speed Apple ---
    public static final DeferredItem<Item> EMPOWERED_SPEED_APPLE =
            MagicApple.ITEMS.registerItem("empowered_speed_apple",
                    properties -> new EmpoweredMagicAppleItem(properties.food(MAGIC_FOOD).rarity(Rarity.EPIC),
                            new MobEffectInstance(MobEffects.SPEED, 3600, 1),
                            new MobEffectInstance(MobEffects.JUMP_BOOST, 400, 0)
                    ));

    // --- Empowered Tide Apple ---
    public static final DeferredItem<Item> EMPOWERED_TIDE_APPLE =
            MagicApple.ITEMS.registerItem("empowered_tide_apple",
                    properties -> new EmpoweredMagicAppleItem(properties.food(MAGIC_FOOD).rarity(Rarity.EPIC),
                            new MobEffectInstance(MobEffects.WATER_BREATHING, 6000, 0),
                            new MobEffectInstance(MobEffects.CONDUIT_POWER, 6000, 0),
